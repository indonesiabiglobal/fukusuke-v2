                    ...
                    <div class="table-responsive table-card mt-3 mb-1">
                        ...
                        <div class="noresult" style="display: none">
                            <div class="text-center">
                                <lord-icon src="{{ URL::asset('build/libs/lordicon/msoeawqm.json') }}" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:75px;height:75px"></lord-icon>
                    ...
                    <div data-simplebar style="height: 242px;" class="mx-n3">
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item" data-id="1">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link name text-reset">Jonny Stromberg</a></h5>
                            ...
                            <li class="list-group-item" data-id="2">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link name text-reset">Jonas Arnklint</a></h5>
                            ...
                            <li class="list-group-item" data-id="3">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link name text-reset">Martina Elm</a></h5>
                            ...
                            <li class="list-group-item" data-id="4">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link name text-reset">Gustaf Lindqvist</a></h5>
                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item" data-id="01">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="contact-name fs-13 mb-1"><a href="#" class="link text-reset">Jonny Stromberg</a></h5>
                            ...
                            <li class="list-group-item" data-id="02">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="contact-name fs-13 mb-1"><a href="#" class="link text-reset">Jonas Arnklint</a></h5>
                            ...
                            <li class="list-group-item" data-id="03">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="contact-name fs-13 mb-1"><a href="#" class="link text-reset">Martina Elm</a></h5>
                            ...
                            <li class="list-group-item" data-id="04">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="contact-name fs-13 mb-1"><a href="#" class="link text-reset">Gustaf Lindqvist</a></h5>
                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link text-reset">Jonny Stromberg</a></h5>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link text-reset">Jonas Arnklint</a></h5>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link text-reset">Martina Elm</a></h5>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-15 mb-1"><a href="#" class="link text-reset">Gustaf Lindqvist</a></h5>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    <lord-icon src="{{ URL::asset('build/libs/lordicon/gsqxdxog.json') }}" trigger="loop" colors="primary:#f7b84b,secondary:#f06548" style="width:100px;height:100px"></lord-icon>
