                ...
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Joseph Parker</td>
                            <td>03 Oct, 2021</td>
                            <td><span class="badge text-info bg-info-subtle">Re-open</span></td>
                        ...
                        <tr>
                            ...
                            <td>Mary Rucker</td>
                            <td>05 Oct, 2021</td>
                            <td><span class="badge text-secondary bg-secondary-subtle">On-Hold</span></td>
                        ...
                        <tr>
                            ...
                            <td>Tonya Noble</td>
                            <td>27 April, 2022</td>
                            <td><span class="badge text-danger  bg-danger-subtle">Closed</span></td>
                        ...
                        <tr>
                            ...
                            <td>Joseph Parker</td>
                            <td>14 June, 2021</td>
                            <td><span class="badge text-warning bg-warning-subtle">Inprogress</span></td>
                            <td><span class="badge bg-info">Medium</span></td>
                            <td>
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <tr>
                            ...
                            <td>James Morris</td>
                            <td>12 March, 2022</td>
                            <td><span class="badge text-primary  bg-primary-subtle">Open</span></td>
                            <td><span class="badge bg-danger">High</span></td>
                            <td>
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <tr>
                            ...
                            <td>Grace Coles</td>
                            <td>07 Jan, 2022</td>
                            <td><span class="badge text-success  bg-success-subtle">New</span></td>
                            <td><span class="badge bg-danger">High</span></td>
                            <td>
                                <div class="dropdown d-inline-block">
                                    <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
