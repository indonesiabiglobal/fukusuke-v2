<div wire:init="loadData">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group col-md-9 col-xs-8">
                                                    <input class="form-control" wire:model.change="jamMatiMesinCode"
                                                        ...
                                                        placeholder="..."  id="jamMatiMesinCode" name="jamMatiMesinCode"
                                        ...
                                        <div class="col-lg-12 mb-1">
                                            <label for="">Lama Mesin Mati</label>
                                            <div class="form-group" style="margin-left:1px; white-space:nowrap">
                                                <input class="form-control bg-light" wire:model.lazy="off_hour" type="time"
                                                    x-ref="offHourInput" max="08:00" disabled
    ...
    <div x-data="{
        cols: JSON.parse(localStorage.getItem('jam-kerja-seitai-cols') || JSON.stringify({1:true,2:true,3:true,4:true,5:true,6:true,7:true,8:true,9:true,10:true,11:true})),
    }" x-init="$watch('cols', val => { try { localStorage.setItem('jam-kerja-seitai-cols', JSON.stringify(val)); } catch(e) {} })"
    class="mt-2 mb-2">
