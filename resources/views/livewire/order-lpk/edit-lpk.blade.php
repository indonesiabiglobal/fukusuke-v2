            ...
            <div class="col-lg-6">
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('qty_lpk') is-invalid @enderror" wire:model.live="qty_lpk" />
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('qty_gentan') is-invalid @enderror" wire:model.live="qty_gentan" />
                        <span class="input-group-text">
                            roll
                        </span>
                        @error('qty_gentan')
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('qty_gulung') is-invalid @enderror" wire:model.live="qty_gulung" />
                        <span class="input-group-text">
                            meter
                        </span>
                        @error('qty_gulung')
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control readonly bg-light @error('panjang_lpk') is-invalid @enderror" readonly="readonly" wire:model="panjang_lpk" />
                        <span class="input-group-text">
                            meter
                        </span>
                        @error('panjang_lpk')
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input wire:model.defer="processdate" type="text" class="form-control @error('processdate') is-invalid @enderror" style="padding:0.44rem" data-provider="flatpickr" data-date-format="d/m/Y">
                        <span class="input-group-text py-0">
                            <i class="ri-calendar-event-fill fs-4"></i>
                        </span>
                        @error('processdate')
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly bg-light"  readonly="readonly" wire:model="defaultgulung" />
                        <span class="input-group-text">
                            meter
                        </span>
                    </div>
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly bg-light"  readonly="readonly" wire:model="selisihkurang" />
                        <span class="input-group-text">
                            meter
                        </span>
                    </div>
