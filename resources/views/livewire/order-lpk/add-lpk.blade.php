            ...
            <div class="col-lg-6">
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('qty_gentan') is-invalid @enderror" wire:model.live.debounce.300ms="qty_gentan" oninput="this.value = window.formatNumber(this.value)"/>
                        <span class="input-group-text">
                            roll
                        </span>
                        @error('qty_gentan')
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('qty_gulung') is-invalid @enderror" wire:model.live.debounce.300ms="qty_gulung" oninput="this.value = window.formatNumber(this.value)" />
                        <span class="input-group-text">
                            meter
                        </span>
                        @error('qty_gulung')
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly @error('panjang_lpk') is-invalid @enderror bg-light" readonly="readonly" wire:model.live="panjang_lpk" oninput="this.value = window.formatNumber(this.value)" />
                        <span class="input-group-text">
                            meter
                        </span>
                        @error('panjang_lpk')
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input class="form-control datepicker-input readonly bg-light" readonly="readonly" type="date" wire:model.defer="order_date" placeholder="yyyy/mm/dd"/>
                    </div>
                </div>
                <div class="form-group mt-1">
                    <div class="input-group">
                        <label class="control-label col-12 col-lg-3 fw-bold text-muted">Buyer</label>
                        <input type="text" class="form-control readonly bg-light"  readonly="readonly" wire:model="buyer_name" />
                    </div>
                </div>
                <div class="form-group mt-1">
                    <div class="input-group">
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly bg-light" readonly="readonly" wire:model="machinename" />
                    </div>
                </div>
                <div class="form-group mt-1">
                    <div class="input-group">
                        <label class="control-label col-12 col-lg-3 fw-bold text-muted">Panjang Total</label>
                        <input type="text" class="form-control readonly bg-light"  readonly="readonly" wire:model="total_assembly_line" />
                        <span class="input-group-text">
                            meter
                        </span>
                    </div>
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly bg-light" readonly="readonly" wire:model="dimensi" oninput="this.value = window.formatNumber(this.value)" />
                    </div>
                </div>
                <div class="form-group mt-1">
                    <div class="input-group">
                        <label class="control-label col-12 col-lg-3 fw-bold text-muted">Default Gulung</label>
                        <input type="text" class="form-control readonly bg-light"  readonly="readonly" wire:model="defaultgulung" oninput="this.value = window.formatNumber(this.value)" />
                ...
                <div class="form-group mt-1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly bg-light"  readonly="readonly" wire:model="selisihkurang" oninput="this.value = window.formatNumber(this.value)" />
                        <span class="input-group-text">
                            meter
                        </span>
                    </div>
