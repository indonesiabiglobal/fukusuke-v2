                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="-" class="form-control readonly bg-light"
                                    readonly="readonly" value="{{ number_format($qty_lpk) }}" />
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 mt-1">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="toolbar">
                    ...
                    <button type="button" class="btn btn-success" wire:click="print" wire:loading.attr="disabled">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="1" class="text-center">
                                                {{ number_format($jumlahBeratLoss, 2) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mt-1">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        class="form-control readonly bg-light {{ $orderLPK != null ? ($orderLPK->progressInfureSelisih < 0 ? 'text-danger' : 'text-info') : '' }}"
                                                        readonly="readonly"
