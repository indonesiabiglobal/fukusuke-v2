            ...
            <div class="col-12 col-lg-6">
                                ...
                                <form wire:submit.prevent="store">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="code" class="form-label">Kode Jenis Produk</label>
                                                <input type="number"
                ...
                <div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="modal-editLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-editLabel">Edit Master Jenis Produk</h5> <button
                                    type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                ...
                {{-- start modal delete groupProduct --}}
                <div id="removeGroupProductModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                    id="close-removeGroupProductModal"></button>
                            </div>
                            <div class="modal-body">
                                <div class="mt-2 text-center">
                                    ...
                                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                        <h4>Are you sure ?</h4>
                                        <p class="text-muted mx-4 mb-0">Are you sure you want to remove this group
                                            Product ?
                                        </p>
                                    </div>
                                </div>
...
<div class="table-responsive table-card mt-3 mb-1">
    ...
    <style>
        #jenisProdukTable.table>:not(caption)>*>* {
...
@script
    <script>
        ...
        // close modal create groupProduct
        ...
        // close modal update groupProduct
        $wire.on('closeModalUpdate', () => {
            $('#modal-edit').modal('hide');
        });

        // show modal delete groupProduct
        $wire.on('showModalDelete', () => {
            $('#removeGroupProductModal').modal('show');
        });

        // close modal delete groupProduct
        ...
        $wire.on('initDataTable', () => {
            initDataTable('jenisProdukTable');
        });
        ...
        function calculateTableHeight() {
            ...
            const offsetTop = document.querySelector('#jenisProdukTable')?.getBoundingClientRect().top || 0;
