                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-addLabel">Add Master Klasifikasi Loss</h5> <button type="button"
    ...
    <div class="table-responsive table-card mt-3 mb-1">
        <table class="table align-middle table-nowrap" id="customerTable" style="width:100%">
            <thead class="table-light">
                <tr>
                    <th>Action</th>
                    <th class="sort">Kode Klasifikasi Loss</th>
                    <th class="sort">Klasifikasi Loss</th>
                    <th class="sort">Status</th>
                    <th class="sort">Update By</th>
