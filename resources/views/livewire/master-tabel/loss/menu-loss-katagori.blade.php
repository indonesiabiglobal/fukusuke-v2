<div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modal-addLabel">Add Master Katagori Loss</h5> <button
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close" id="close-removeBuyerModal"></button>
                                </div>
                                <div class="modal-body">
    ...
    <div class="table-responsive table-card mt-3 mb-1">
        <table class="table align-middle table-nowrap" id="lossCategoryTable" style="width:100%">
    ...
    <style>
        #lossCategoryTable.table>:not(caption)>*>* {
...
@script
    <script>
        ...
        function calculateTableHeight() {
            ...
            const offsetTop = document.querySelector('#lossCategoryTable')?.getBoundingClientRect().top || 0;
