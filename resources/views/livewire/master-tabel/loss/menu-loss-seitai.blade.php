<div class="row">
            ...
            <div class="col-12 col-lg-6">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-addLabel">Add Master Loss Seitai</h5> <button
                ...
                <div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="modal-editLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-editLabel">Edit Master Loss Seitai</h5> <button
                                    type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
    ...
    <div class="table-responsive table-card mt-3 mb-1">
        <table class="table align-middle table-nowrap" id="LossSeitaiTable" style="width:100%">
...
@script
    <script>
        ...
        function initDataTable() {
            ...
            let table = $.fn.dataTable.isDataTable('#LossSeitaiTable') ?
                $('#LossSeitaiTable').DataTable() :
                null;
            ...
            table = $('#LossSeitaiTable').DataTable({
                "pageLength": 10,
                "searching": true,
                "responsive": true,
                "order": [
