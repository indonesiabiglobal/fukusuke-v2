            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                                ...
                                <div class="modal-body">
                                    <form wire:submit.prevent="store">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-xxl-12">
                                                <div>
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="code" wire:model.defer="code" maxlength="20"
                                                           placeholder="Kode/Code"
                                            ...
                                            <div class="col-xxl-12">
                                                <div class="row">
                                                    <label class="form-label">Machine Part</label>
                                                    <select data-choices data-choices-sorting="true"
                                                            class="form-select @error('machine_part_id') is-invalid @enderror"
                                                            wire:model="machine_part_id">
                                                        <option value="" selected>Silahkan Pilih</option>
                                                        @foreach (\App\Models\MsMachinePart::select('id','part_machine','code')->active()->get() as $mp)
                                                            <option value="{{ $mp->id }}">
                                                                {{ $mp->part_machine }} ({{ $mp->code }})
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('machine_part_id') <span class="invalid-feedback">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                    ...
                    <div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="modal-editLabel" aria-modal="true" wire:ignore.self>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-xxl-12">
                                                <div>
                                                    ...
                                                    <input type="text"
                                                           class="form-control @error('code') is-invalid @enderror"
                                                           id="code_edit" wire:model.defer="code" maxlength="20"
                                                           placeholder="Kode/Code"
                                                           oninput="this.value = this.value.toUpperCase()">
                                                    @error('code') <span class="invalid-feedback">{{ $message }}</span> @enderror
                                                </div>
                        ...
                        {{-- Status (muncul hanya jika sebelumnya non-aktif) --}}
                                ...
                                <div class="modal-body">
                                    <div class="mt-2 text-center">
                                        ...
                                        <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                            <h4>Are you sure ?</h4>
                                            <p class="text-muted mx-4 mb-0">Are you sure you want to remove this machine part detail?</p>
                                        </div>
                                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="col text-end dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <label style="cursor: pointer;">
                                    <input class="form-check-input fs-15 ms-2 toggle-column" type="checkbox" data-column="7" checked>
                                    Updated
                                </label>
                            </li>
                        </ul>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center">
                            ...
                            <p class="text-muted mb-0">No machine part detail found for your search.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
