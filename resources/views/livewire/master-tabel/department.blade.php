<div class="row">
            ...
            <div class="col-12 col-lg-6">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-addLabel">Add Master Departemen</h5> <button
                            ...
                            <div class="modal-body">
                                <form wire:submit.prevent="store">
                                    <div class="row g-3">
                                        ...
                                        {{-- kota departemen --}}
                                        <div class="col-xxl-12">
                                            <div> <label for="divisionCode" class="form-label">Kode Divisi</label>
                                                <input type="number"
                                                    class="form-control @error('divisionCode') is-invalid @enderror"
                                                    id="divisionCode" wire:model.defer="divisionCode"
                ...
                <div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="modal-editLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-editLabel">Edit Master Departemen</h5> <button
                                    type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                ...
                {{-- start modal delete departemen --}}
                <div id="removeDepartemenModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                    id="close-removeDepartemenModal"></button>
                            </div>
                            <div class="modal-body">
                                <div class="mt-2 text-center">
                                    ...
                                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                        <h4>Are you sure ?</h4>
                                        <p class="text-muted mx-4 mb-0">Are you sure you want to remove this departemen
                                            ?
                                        </p>
                                    </div>
                                </div>
                ...
                <form wire:submit.prevent="search">
                    <div class="input-group">
                        <input wire:model.defer="searchTerm" class="form-control"style="padding:0.44rem"
                            type="text" placeholder="search kode,nama departemen" />
                        ...
                        <li>
                            <label style="cursor: pointer;">
                                <input class="form-check-input fs-15 ms-2 toggle-column" type="checkbox"
                                    data-column="1" checked> Kode Departemen
                            </label>
                        </li>
                        <li>
                            <label style="cursor: pointer;">
                                <input class="form-check-input fs-15 ms-2 toggle-column" type="checkbox"
                                    data-column="2" checked> Nama Departemen
                            </label>
                        </li>
                        <li>
                            <label style="cursor: pointer;">
                                <input class="form-check-input fs-15 ms-2 toggle-column" type="checkbox"
                                    data-column="3" checked> Kode Divisi
                            </label>
                        </li>
                        <li>
                            <label style="cursor: pointer;">
    ...
    <div class="table-responsive table-card mt-3 mb-1">
        <table class="table align-middle table-nowrap" id="departmentTable" style="width:100%">
                ...
                @forelse ($data as $item)
                    <tr>
                        <td>
                            ...
                            <button type="button" class="btn fs-15 p-1 bg-danger rounded removeDepartemenModal"
...
@script
    <script>
        ...
        // close modal create departemen
        $wire.on('closeModalCreate', () => {
            $('#modal-add').modal('hide');
        });

        // close modal update departemen
        $wire.on('closeModalUpdate', () => {
            $('#modal-edit').modal('hide');
        });

        // show modal delete departemen
        $wire.on('showModalDelete', () => {
            $('#removeDepartemenModal').modal('show');
        });

        // close modal delete departemen
        $wire.on('closeModalDelete', () => {
            $('#removeDepartemenModal').modal('hide');
        });
        ...
        function initDataTable() {
            ...
            let table = $.fn.dataTable.isDataTable('#departmentTable') ?
