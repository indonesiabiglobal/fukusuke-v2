<div class="row">
            ...
            <div class="col-12 col-lg-6">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-addLabel">Add Master Inner</h5> <button type="button"
                                ...
                                <form wire:submit.prevent="store">
                                    <div class="row g-3">
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="code" class="form-label">Kode Inner</label>
                                                <input type="number"
                                        ...
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="name" class="form-label">Nama Inner</label>
                                                <input type="text"
                ...
                <div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="modal-editLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-editLabel">Edit Master Inner</h5> <button
                            ...
                            <div class="modal-body">
                                <form wire:submit.prevent="update">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="box_class" class="form-label">Klasifikasi</label>
                                                <select class="form-control @error('box_class') is-invalid @enderror"
                ...
                <div class="col text-end dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <label style="cursor: pointer;">
                                <input class="form-check-input fs-15 ms-2 toggle-column" type="checkbox"
                                    data-column="2" checked> Nama Inner
                            </label>
                        </li>
                        <li>
                            <label style="cursor: pointer;">
    ...
    <div class="table-responsive table-card mt-3 mb-1">
        <table class="table align-middle table-nowrap" id="innerTable" style="width:100%">
