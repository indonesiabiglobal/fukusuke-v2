            ...
            <div class="col-12 col-lg-6">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-addLabel">Add Master Gaiso</h5> <button type="button"
                                ...
                                <form wire:submit.prevent="store">
                                    <div class="row g-3">
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="code" class="form-label">Kode Gaiso</label>
                                                <input type="number"
                                        ...
                                        <div class="col-xxl-12">
                                            <div>
                                                <label for="name" class="form-label">Nama Gaiso</label>
                                                <input type="text"
                ...
                <div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="modal-editLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-editLabel">Edit Master Gaiso</h5> <button
                ...
                <div class="col text-end dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <label style="cursor: pointer;">
                                <input class="form-check-input fs-15 ms-2 toggle-column" type="checkbox"
                                    data-column="2" checked> Nama Gaiso
                            </label>
                        </li>
                        <li>
                            <label style="cursor: pointer;">
...
<div class="table-responsive table-card mt-3 mb-1">
    <table class="table align-middle table-nowrap" id="gaisoTable" style="width:100%">
                ...
                <tr>
                    <td>
                        ...
                        <button {{ $item->status == 0 ? 'hidden' : '' }} type="button"
                            class="btn fs-15 p-1 bg-danger rounded removeGaisoModal btn-delete"
...
@script
    <script>
        ...
        function calculateTableHeight() {
            ...
            const offsetTop = document.querySelector('#gaisoTable')?.getBoundingClientRect().top || 0;
