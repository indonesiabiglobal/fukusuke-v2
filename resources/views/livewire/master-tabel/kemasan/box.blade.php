                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal-addLabel">Add Master Box</h5> <button type="button"
...
@script
    <script>
        ...
        function calculateTableHeight() {
            ...
            const offsetTop = document.querySelector('#boxTable')?.getBoundingClientRect().top || 0;
