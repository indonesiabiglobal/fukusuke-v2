            ...
            <div class="input-group">
                ...
                <select class="form-control" wire:model.defer="jenisreport" placeholder="- pilih jenis report -">
                    ...
                    <optgroup label="Daftar Loss">
                        ...
                        <option value="Daftar Loss Per Mesin dan Jenis">15. Daftar Loss Per Mesin dan Jenis</option>
                        <option value="Daftar Kasus Loss Per Mesin dan Jenis">16. Daftar Kasus Per Mesin dan Jenis</option>
                    </optgroup>
                    <optgroup label="Kapasitas">
                        <option value="Kapasitas Produksi">17. Kapasitas Produksi</option>
                    </optgroup>
                    <optgroup label="Jam Mati Mesin">
                        <option value="Jam Mati Per Mesin">18. Jam Mati Per Mesin</option>
                        <option value="Jam Mati Per Jenis">19. Jam Mati Per Jenis</option>
                    </optgroup>
                </select>
            </div>
        </div>
