            ...
            <div class="col-12 col-lg-12">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input wire:model.defer="kenpin_date" type="text" class="form-control  readonly bg-light" readonly="readonly" style="padding:0.44rem"
            ...
            <div class="col-12 col-lg-12 mt-1">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control readonly bg-light" readonly="readonly" wire:model="kenpin_no" />
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" placeholder="-" maxlength="10" readonly="readonly"
                            class="form-control col-4 readonly bg-light" wire:model.change="code"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-md-9 col-xs-8">
                                        <input class="form-control" type="text" wire:model.defer="qty_loss"
                                            placeholder="..." oninput="this.value = window.formatNumberDecimal(this.value)" />
                                        @error('qty_loss')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
