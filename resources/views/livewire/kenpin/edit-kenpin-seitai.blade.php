                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="date"
                            max="{{ now()->format('Y-m-d') }}" wire:model.change="incident_date" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-12">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input wire:model.defer="kenpin_date" type="date" class="form-control"
                    ...
                    <div class="input-group">
                        ...
                        <div class="col-12 col-lg-10" x-data="{ kenpin_no: @entangle('kenpin_no').live, status: true }" x-init="$watch('kenpin_no', value => {})">
                            <input type="text" class="form-control readonly bg-light" readonly="readonly"
                                x-model="kenpin_no" wire:model="kenpin_no" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <div class="col-12 col-lg-10">
                            <div class="d-flex">
                                <div class="flex-grow-1 me-2" x-data="{ nomor_palet: @entangle('nomor_palet').live, status: true }" x-init="$watch('nomor_palet', value => {
                                    ...
                                    <input type="text" class="form-control" x-model="nomor_palet"
                                        ...
                                        x-on:keydown.tab="$event.preventDefault(); $refs.kodeProdukInput.focus();"
                                        placeholder="A0000-000000" @disabled($status_kenpin_old == 2) />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-12 mt-1">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select wire:model.change="department_id" class="form-control readonly bg-light"
            ...
            <div class="col-12 col-lg-4 mt-1">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" placeholder="Kode Produk" disabled
                            class="form-control readonly bg-light @error('kode_produk') is-invalid @enderror"
                            wire:model.live="kode_produk" x-ref="kodeProdukInput" maxlength="30"
            ...
            <div class="col-12 col-lg-8 mt-1">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text"
                            class="form-control @error('nama_produk') is-invalid @enderror readonly bg-light"
            ...
            <div class="col-12 col-lg-8 mt-1">
                <div class="form-group">
                    <div class="input-group">
                        <label class="control-label"></label>
                        <input type="text"
                            class="form-control @error('nama_ng') is-invalid @enderror readonly bg-light"
            ...
            <div class="col-12 col-lg-12 mt-1" @if ($department_id == 2) style="display: none" @endif>
                <div class="form-group">
                    <div class="input-group">
                        <label class="control-label col-12 col-lg-2">Bagian Mesin</label>
                        <div class="col-12 col-lg-10" wire:ignore>
                            <select id="bagian-mesin-seitai" name="bagian_mesin_id" class="form-control" data-choices
                                data-choices-search-false>
                                <option value="">- Pilih Bagian Mesin -</option>
                                @foreach ($bagianMesinListSeitai as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $bagian_mesin_id == $item->id ? 'selected' : '' }}>
                                        {{ $item->code . ' - ' . $item->name }}
                                    </option>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="h6 modal-title">Edit Palet Seitai</h2>
                    ...
                    <table class="table table-centered table-nowrap mb-0 rounded">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-primary p-1"
                                            ...
                                            @disabled($status_kenpin_old == 2) wire:target="edit({{ $item->id }})">
                                        ...
                                        <button type="button" class="btn btn-danger p-1"
                                            ...
                                            <span wire:loading.remove wire:target="deleteSeitai({{ $item->id }})">
                                                <i class="ri-delete-bin-4-fill"></i>
                                            </span>
                                            <span wire:loading wire:target="deleteSeitai({{ $item->id }})">
                                                <span class="spinner-border spinner-border-sm" role="status">
                                                    <span class="visually-hidden">Loading...</span>
                                                </span>
                                            </span>
                                    ...
                                    <td>
                                        @if (isset($item->waktu_kenpin_dari) && isset($item->waktu_kenpin_sampai))
                                            {{ $item->waktu_kenpin_dari }} - {{ $item->waktu_kenpin_sampai }}
                                        @elseif (isset($item->waktu_kenpin_dari))
                                            {{ $item->waktu_kenpin_dari }}
                                        @else
                                            -
                                        @endif
                                    </td>
                            ...
                            <tr>
                                ...
                                <td colspan="1" class="text-center">{{ number_format($qtyLossTotal) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
