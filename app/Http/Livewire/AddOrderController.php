...
class AddOrderController extends Component
{
    ...
    public function save()
    {
        ...
        try {
            ...
            $product = MsProduct::where('code', $this->product_id)->first();
            $order = new TdOrders();
            $order->processdate = Carbon::parse($this->process_date)->format('Y-m-d');
            $order->po_no = $this->po_no;
            $order->order_date = Carbon::parse($this->order_date)->format('Y-m-d');
            ...
            $order->stufingdate = Carbon::parse($this->stufingdate)->format('Y-m-d');
            $order->etddate = Carbon::parse($this->etddate)->format('Y-m-d');
            $order->etadate = Carbon::parse($this->etadate)->format('Y-m-d');
