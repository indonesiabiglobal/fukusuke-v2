...
class InnerController extends Component
{
    ...
    private function exportInner()
    {
        ...
        $activeWorksheet->setCellValue('A1', 'MASTER KEMASAN INNER - ' . Carbon::now()->translatedFormat('M Y'));
        ...
        $data = MsPackagingInner::orderBy('code', 'ASC')->get();
        ...
        $response->headers->set('Content-Disposition', 'attachment; filename="Master-Kemasan-Inner.xlsx"');
