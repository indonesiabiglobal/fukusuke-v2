...
class GaisoController extends Component
{
    ...
    private function exportGaiso()
    {
        ...
        $activeWorksheet->setCellValue('A1', 'MASTER KEMASAN GAISO - ' . Carbon::now()->translatedFormat('M Y'));
        ...
        $data = MsPackagingGaiso::orderBy('code', 'ASC')->get();
        ...
        $response->headers->set('Content-Disposition', 'attachment; filename="Master-Kemasan-Gaiso.xlsx"');
