...
class BarangRejectController extends Component
{
    ...
    public function render()
    {
        ...
        // $data = DB::table(DB::raw("select SQL_CALC_FOUND_ROWS * from (SELECT a.item_code, a.item_name, a.unit_code, a.item_type_code, a.item_group, '' as location_code, IFNULL(b.awal,IFNULL(x.awal,0)) as awal,  
        //     IFNULL(c.masuk,0) as masuk, IFNULL(d.keluar,0) as keluar, IFNULL(e.peny,0) as peny,  
        //     (IFNULL(b.awal,IFNULL(x.awal,0)) + IFNULL(c.masuk,0) - IFNULL(d.keluar,0) + IFNULL(e.peny,0)) as akhir, IFNULL(f.opname,IFNULL(y.opname,0)) as opname 
        //     ,0 selisih FROM ms_item a  
        ...
        //         WHERE a.trans_date BETWEEN '$tgl_awal'  AND '$tgl_akhir' AND c.item_group='WIP'  
        ...
        //     WHERE a.item_group='SCRAP' $strqW) as a  "));

        // $data = $data->get();

        return view('livewire.inventory.barang-reject', [
            // 'data' => $data,
