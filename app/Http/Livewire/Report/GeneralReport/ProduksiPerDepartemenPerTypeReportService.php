...
class ProduksiPerDepartemenPerTypeReportService
{
    public static function daftarProduksiPerDepartemenPerTypeInfure($nippon, $jenisReport, $tglMasuk, $tglKeluar)
    {
        ...
        $data = DB::select("
            ...
            ORDER BY department_name, product_type_code
        ");
