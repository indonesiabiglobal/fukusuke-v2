...
class LossPerDepartemenPerJenisReportService
{
    public static function daftarLossPerDepartemenPerJenisInfure($nippon, $jenisReport, $tglMasuk, $tglKeluar)
    {
        ...
        $data = DB::select("
            ...
            ORDER BY MAX(dep.name) ASC, MAX(mslos.code) ASC
        ");
